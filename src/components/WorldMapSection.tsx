    ...
    <section id="world" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-base leading-[2.2] mt-2 max-w-2xl mx-auto">An Egg will journey across the 16 territories, embodying a shared will for transformation, connection, and the rebirth of a new world founded on harmony.</p>
        </motion.div>
